export interface CellMapUnit_I {
    id: string;
    hash: number;
...
/**
 * CellMap - Spatial Hash Grid that extends Map
 */
export default class CellMap<V extends CellMapUnit_I> extends Map<string, V>  {
    ...
    deleteAndGet(id: string): V | undefined {
        const v = this.get(id);
        this.delete(id);
        return v;
    }
